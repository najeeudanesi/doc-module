...
const Pediatrics = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      ...
      painAssessment: {
        ...
        severityLevel: parseInt(formData.painAssessment.severityLevel) || 0
      },
      warningSign: {
        ...formData.warningSign,
        childFever: {
          ...formData.warningSign.childFever,
          temperature: parseFloat(formData.warningSign.childFever.temperature) || 0
        }
      }
    };
    ...
    try {
      ...
      if (response?.isSuccess) {
        notification({
          title: 'Success',
          message: 'Pediatric consultation record saved successfully',
          type: 'success'
        });
  ...
  return (
    <div className="consultation-container m-t-40">
          ...
          <section className="form-section">
            ...
            <div className="field-group">
              ...
              <select
                ...
                onChange={(e) => handleChange('symptomAnalysis', '', 'symptomStatus', parseInt(e.target.value))}
                className="input-field"
              >
          ...
          <section className="form-section">
            ...
            {formData.painAssessment.childPain.anyPain && (
              <>
                ...
                <div className="field-group">
                  <label>Pain Severity Level (0-10)</label>
                  <input
                    type="number"
                    min="0"
                    max="10"
                    value={formData.painAssessment.severityLevel}
                    onChange={(e) => handleChange('painAssessment', '', 'severityLevel', parseInt(e.target.value) || 0)}
                    className="input-field"
                  />
                  <small className="helper-text">0 = No pain, 10 = Worst possible pain</small>
                </div>
              </>
            )}
          </section>
          ...
          <section className="form-section">
            ...
            {formData.warningSign.childFever.runningFever && (
              <div className="field-group">
                ...
                <input
                  ...
                  onChange={(e) => handleChange('warningSign', 'childFever', 'temperature', parseFloat(e.target.value))}
                  className="input-field"
                />
              </div>
            )}
            ...
            <div className="field-group">
              <label>
                <input
                  type="checkbox"
                  checked={formData.warningSign.anyAppetiteWeightLoss}
                  onChange={(e) => handleChange('warningSign', '', 'anyAppetiteWeightLoss', e.target.checked)}
                />
          ...
          <section className="form-section">
            ...
            <div className="field-group">
              ...
              <GhostTextCompletion
                ...
                handleChange={(e) => handleDirectChange('treatmentSchedule', e.target.value)}
                none={true}
              />
            </div>
          </section>
