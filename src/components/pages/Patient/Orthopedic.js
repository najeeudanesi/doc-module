            ...
            <div className="input-row">
              ...
              <div className="field-column">
                ...
                <GhostTextCompletion
                  ...
                  value={
                    formData["symptomAnalysis.describePain"] || ""
                  }
                  handleChange={handleChange}
                  none={true}
                />
            ...
            <div className="section-box m-t-10">
              ...
              <div className="field-column">
                ...
                <GhostTextCompletion
                  ...
                  value={
                    formData["painBehavior.painReliever"] || ""
                  }
                  handleChange={handleChange}
                  none={true}
                />
              ...
              <div className="field-column">
                ...
                <GhostTextCompletion
                  ...
                  value={
                    formData["painBehavior.painAggravator"] || ""
                  }
                  handleChange={handleChange}
                  none={true}
                />
            ...
            <div className="section-box m-t-10">
              ...
              <div className="field-column">
                ...
                {/* <textarea
                  ...
                  className="input-field"
                  rows={6}
                  value={formData["lifeStyleRisk.injurySurgery.describe"] || ""}
                /> */}
              </div>
              <div className="radio-row">
