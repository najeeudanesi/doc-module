...
function ImmunizationAttachment({ closeModal, data }) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await post('/Appointment/update-appointment', requestBody);
        ...
        <div className='overlay'>
            ...
            <div className="appointmentModal">
                <div className="apointmentHeader">
                    ...
                    {!isEditable ? (
                        <button className="appointmentButton pointer" onClick={handleEditClick}>Re-schedule Appointment</button>
                    ) : (
                        <button className="appointmentButton pointer" disabled={isloading} onClick={handleSubmit}>Update Appointment</button>
                    )}
                </div>
            </div>
        </div>
